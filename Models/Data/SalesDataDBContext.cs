...
public partial class SalesDataDBContext : DbContext
{
    public SalesDataDBContext(DbContextOptions<SalesDataDBContext> options)
        : base(options)
    { }
    ...
    public DbSet<OrderTotalsByYear> OrderTotalsByYears { get; set; }
